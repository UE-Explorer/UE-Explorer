...
{
    internal sealed class ListingContextPage : Page, ITrackingContext, IContextListener
    {
        private readonly ContextService _ContextService;
        private readonly TextEditorPanel _EditorPanel;
        private readonly ListingDecompiler _Decompiler = new ListingDecompiler();

        private object _CurrentContextTarget;
        private CancellationToken _CancellationToken;

        public ListingContextPage()
        {
        ...
        public bool CanAccept(ContextInfo context) =>
            IsTracking && _Decompiler.CanDecompile(context.ResolvedTarget as IAcceptable);
        ...
        private async void BuildListing(IAcceptable target)
        {
            ...
            var outputDecompiler = new ListingOutputDecompiler(outputStream);
            
            _CancellationToken = new CancellationToken(false);
            await _Decompiler.Run(target, outputDecompiler, _CancellationToken);
