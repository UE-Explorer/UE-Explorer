...
{
    private static readonly VkString EngineName = new("Vortice");
    ...
    public GraphicsDevice(string applicationName, bool enableValidation, IntPtr windowHandle, int width, int height)
    {
        ...
        instanceExtensions.AddRange(new[]
        {
        ...
        if (CheckDeviceExtensionSupport(VK_KHR_ACCELERATION_STRUCTURE_EXTENSION_NAME, availableDeviceExtensions))
        {
            ...
            accelerationStructureFeatures.sType = VkStructureType.PhysicalDeviceAccelerationStructureFeaturesKHR;
        ...
        VkPhysicalDevice device, VkSurfaceKHR surface)
    {
        ...
        var graphicsFamily = VK_QUEUE_FAMILY_IGNORED;
        var presentFamily = VK_QUEUE_FAMILY_IGNORED;
        uint i = 0;
