...
namespace Eliot.Extensions.ExecGenerator
{
    ...
    public partial class UC_ExecGenerator : UserControl_Tab
    {
        ...
        private void Button_Save_Click(object sender, EventArgs e)
        {
            ...
            string buffer = "{{autogenerated}}\r\nEvery [[console command]] declared in [[UnrealScript]] of [[" +
                            gameprefix + "]] is listed here.\r\n";
            ...
            string savePath = Path.Combine(Application.StartupPath,
                engineprefix + " Console Commands (" + gameprefix + ").txt");
